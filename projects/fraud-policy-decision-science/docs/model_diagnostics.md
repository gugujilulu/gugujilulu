...
AUC differences are descriptive point estimates. A paired holdout bootstrap would quantify their uncertainty. In the generated low-observability population, the same-information challenger performs worse than the production proxy; adding the PSP feature improves ranking. This comparison makes the choice of information available at authorization central to the modeling decision.
